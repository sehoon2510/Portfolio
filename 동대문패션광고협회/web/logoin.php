    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="row dis-center">
                <div class="login dis-col align-center">
                    <div class="title dis-col align-center">
                        <p class="noto-bold">로그인</p>
                        <p class="tahoma">LOGIN</p>
                    </div>
                    <form action="./login_process.php" method="post" enctype="multipart/form-data">
                        <div class="dis-col">
                            <input name="id" type="text" class="noto-regular" placeholder="아이디">
                            <input name="pass" type="password" class="noto-regular" placeholder="비밀번호">
                            <p>비밀번호를 잊어버리셨나요?</p>
                        </div>
                        <button type="submit" class="noto-medium">로그인</button>
                        <p class="dis-row">아직 회원이 아니십니까? <span id="JoinOpen">회원가입</span></p>
                    </form>
                </div>
            </div>
            <div class="popup dis-col align-center p">
                <div class="title dis-col align-center p">
                    <p class="noto-bold p">회원가입</p>
                    <p class="tahoma p">JOIN</p>
                </div>
                <form action="./join_process.php" method="post" class="p">
                    <div class="dis-col p">
                        <input name="id" type="text" class="noto-regular" placeholder="아이디" class="p">
                        <input name="pass" type="password" class="noto-regular" placeholder="비밀번호" class="p">
                        <input name="name"  type="text" class="noto-regular" placeholder="이름" class="p">
                        <input name="email"  type="email" class="noto-regular" placeholder="email" class="p">
                    </div>
                    <button type="submit" class="noto-medium p">회원가입</button>
                    <p class="dis-row p">이미 계정이 있으신가요? <span id="JoinClose" class="p">로그인</span></p>
                </form>
            </div>
        </section>
        <footer>
