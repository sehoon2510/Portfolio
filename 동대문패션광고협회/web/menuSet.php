            ...
            <div class="row">
                <div class="menuset">
                    <div class="title dis-col align-center">
                        <p class="noto-bold">메뉴관리</p>
                        <p class="tahoma">MANAGEMENT</p>
                    </div>
                    <div class="menuaddter dis-row">
                        <button id="add"><i class="fa-solid fa-plus"></i></button>
                        <div class="list" id="list">
                            <div class="mainmenu dis-row just-bet" id="mainmenu">
                            
                            </div>
                            <div class="submenu dis-row just-bet" id="submenu">
